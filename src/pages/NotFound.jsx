    ...
    return (<div className='flex min-h-screen flex-col'>
        ...
        <div className='layout-container flex flex-1 flex-col items-center justify-center py-40'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <p className='mb-10 text-gray-500'>Maybe it was moved or you mistyped the URL.</p>
                <Link to='/' className='rounded-xl bg-blue-600 p-3 font-bold text-white'>Back to Main</Link>
            </div>
        </div>
        <Footer/>
    </div>)
