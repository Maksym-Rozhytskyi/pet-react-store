        ...
        <div className='bg-linear-to-b from-indigo-50 to-white'>
            <div className='mx-auto w-full max-w-7xl px-4 pt-20 pb-24'>
                <div className='flex w-1/2 flex-col'>
                    ...
                    <p className='mb-10 max-w-lg text-lg font-normal text-gray-500'>A wide range of verified products
                        — from electronics to clothing. Fast delivery, fair prices, and effortless shopping in <br></br> <span
                            className='font-bold text-indigo-500'> one place.</span></p>
                    <div className='flex items-center gap-2 pb-10'>
                        <a href=''
                           className='rounded-xl bg-indigo-600 px-6 py-3 text-white transition-colors hover:bg-indigo-700'>Browse
                            Catalog</a>
                        <a href='' className='px-6 py-3 text-gray-500'>Learn More →</a>
                    </div>
