...
function Features() {
    return (<div className='max-w-7xl mx-auto w-full pt-20 pb-24 px-4'>
        ...
        <div className="flex flex-wrap gap-5">
            ...
            <div
                ...
                <p className="text-sm text-gray-500 leading-relaxed">All transactions are protected. We support cards,
            ...
            <div
                ...
                <p className="text-sm text-gray-500 leading-relaxed">Our support team is always online and ready to help
                    with any question.</p>
            </div>
            ...
            <div
                ...
                <p className="text-sm text-gray-500 leading-relaxed">Not satisfied? Return any item within 30 days — no
                    questions asked.</p>
            </div>
