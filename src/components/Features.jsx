    ...
    <div className='layout-container pt-20'>
      <div className='flex flex-col items-center justify-center pb-10'>
        ...
        <p className='text-xl text-gray-500'>
          We built our store around what matters most to customers.
        </p>
      </div>
      <div className='flex flex-wrap gap-5 pb-20'>
        ...
        >
          ...
          <p className='text-sm leading-relaxed text-gray-500'>
            We deliver your order within 1–3 business days anywhere in the
            country.
          </p>
        </div>
        ...
        >
          ...
          <p className='text-sm leading-relaxed text-gray-500'>
            All transactions are protected. We support cards, Apple Pay and
            Google Pay.
          </p>
        </div>
        ...
        >
          ...
          <p className='text-sm leading-relaxed text-gray-500'>
            Our support team is always online and ready to help with any
            question.
          </p>
        </div>
        <div
